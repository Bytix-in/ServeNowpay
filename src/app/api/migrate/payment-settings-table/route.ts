...
export async function POST() {
  try {
    return NextResponse.json({
      message: 'Please run the following SQL script in your Supabase SQL editor to create the payment_settings table:',
      sql: `
...
ORDER BY ordinal_position;
      ...
      instructions: [
        ...
        '5. Run the query',
        '6. Verify that the payment_settings table was created successfully'
      ]
    })
