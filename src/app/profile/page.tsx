      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 py-8">
          ...
          >
            ...
            <p className="text-gray-600 mt-1">Invoice for Order #{selectedOrder.unique_order_id || selectedOrder.id.slice(-8)}</p>
          </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <div>
            ...
            <p className="text-gray-600">Welcome back, {userSession?.name}</p>
          </div>
          <div className="flex items-center space-x-3">
            <div className="text-right">
              <p className="text-sm text-gray-600">Logged in as</p>
              <p className="font-medium text-gray-900">{userSession?.phone}</p>
            </div>
            <Button
