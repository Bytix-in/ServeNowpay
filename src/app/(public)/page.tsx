    ...
    <div className={`min-h-screen bg-black ${comfortaa.className}`}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        <div className="container mx-auto px-4 py-20 relative z-20">
          ...
          <motion.div
            ...
            className="relative text-center mb-12 z-20"
          >
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-12 leading-relaxed max-w-3xl mx-auto drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              ...
              <Link href="/contact" className="group">
                <div className="bg-gray-900 text-white px-8 py-4 rounded-2xl flex items-center justify-center transition-all hover:shadow-lg border-2 border-gray-700">
      ...
      <section className="bg-black/20 backdrop-blur-md py-20 relative z-10">
        <div className="container mx-auto px-4">
          ...
          >
            {/* Lightning Fast */}
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
            ...
            {/* Cloud-Based */}
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
              <div className="w-16 h-16 bg-blue-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-500/30">
                <Globe className="w-8 h-8 text-blue-400" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Cloud-Based</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Analytics Driven</h3>
              <p className="text-gray-300 leading-relaxed">
      ...
      <section className="bg-black/20 backdrop-blur-md py-20 relative z-10">
        <div className="container mx-auto px-4">
          ...
          >
            {/* Step 1 - Scan QR Code */}
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
