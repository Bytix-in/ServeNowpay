...
export default function HomePage() {
  ...
  return (
    <div className={`min-h-screen bg-black ${comfortaa.className}`}>
      {/* Fixed Hyperspeed Background - Throughout entire homepage */}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 relative z-20">
          ...
          <motion.div
            ...
            className="relative text-center mb-8 sm:mb-12 z-20"
          >
            <div className="inline-flex items-center px-3 sm:px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white text-xs sm:text-sm font-medium mb-6 sm:mb-8 border border-white/20">
              <Rocket className="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
              <span className="hidden sm:inline">Revolutionary Restaurant Management</span>
              <span className="sm:hidden">Restaurant Management</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative text-center max-w-4xl mx-auto z-20"
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 sm:mb-12 leading-relaxed max-w-3xl mx-auto drop-shadow-md px-4 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-12 sm:mb-16 px-4 sm:px-0">
              <Link href="/access" className="group w-full sm:w-auto">
                <div className="bg-black dark:bg-black text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl flex items-center justify-center transition-all hover:shadow-lg border border-transparent">
                  <span className="text-lg sm:text-xl font-bold">Get Started Today</span>
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 ml-3 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </Link>
              <Link href="/contact" className="group w-full sm:w-auto">
                <div className="bg-gray-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl flex items-center justify-center transition-all hover:shadow-lg border-2 border-gray-700">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-lg sm:text-xl font-bold">Schedule Demo</span>
                </div>
              </Link>
            </div>
          </motion.div>
      ...
      {/* Features Section */}
      <section className="bg-black/20 backdrop-blur-md py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
              Built for modern restaurants with cutting-edge technology and user-friendly design.
            </p>
          </motion.div>
          ...
          >
            {/* Lightning Fast */}
            <div className="bg-white/10 backdrop-blur-lg p-6 sm:p-8 rounded-2xl shadow-2xl border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-yellow-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 border border-yellow-500/30">
            ...
            {/* Cloud-Based */}
            <div className="bg-white/10 backdrop-blur-lg p-6 sm:p-8 rounded-2xl shadow-2xl border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 border border-blue-500/30">
                <Globe className="w-6 h-6 sm:w-8 sm:h-8 text-blue-400" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Cloud-Based</h3>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
            ...
            {/* Analytics Driven */}
            <div className="bg-white/10 backdrop-blur-lg p-6 sm:p-8 rounded-2xl shadow-2xl border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 border border-green-500/30">
                <BarChart3 className="w-6 h-6 sm:w-8 sm:h-8 text-green-400" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Analytics Driven</h3>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
      ...
      <section className="bg-black/20 backdrop-blur-md py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="text-center mb-12 sm:mb-16"
          >
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-medium text-white max-w-4xl mx-auto leading-relaxed px-4 sm:px-0">
      ...
      <section className="bg-black/20 backdrop-blur-md py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Step 1 - Scan QR Code */}
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 sm:p-8 text-center shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
      ...
      <section className="bg-black/20 backdrop-blur-md py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Quick Setup */}
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 sm:p-8 text-center border border-white/20 shadow-2xl">
          ...
          >
            <Link
              href="/contact"
              className="inline-flex items-center bg-yellow-400 text-black px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:bg-yellow-300 transition-colors w-full sm:w-auto justify-center"
            >
              <Mail className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5" />
              <span className="hidden sm:inline">Contact Us Now for Easy Onboarding</span>
      ...
      <section className="bg-black/20 backdrop-blur-md py-20 relative z-10">
