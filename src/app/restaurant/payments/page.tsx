        ...
        {!paymentSettings ? (
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-yellow-800 mb-1">Payment Setup Required</h3>
                <p className="text-yellow-700">
                  You need to configure your Cashfree credentials to accept payments from customers.
                </p>
              </div>
            </div>
          </div>
